                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <button
                                class="quantity-change-button" 
                                @click="increaseOne(shoppingCartItems[1].id)">+</button>
                            </div>
                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <button
                                class="quantity-change-button" 
                                @click="increaseOne(shoppingCartItems[2].id)">+</button>
                            </div>
                            <button class="remove-item">✕</button>
                        </div>
                    </div>
                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <button
                                class="quantity-change-button" 
                                @click="increaseOne(shoppingCartItems[3].id)">+</button>
                            </div>
                            <button class="remove-item">✕</button>
                        </div>
                    </div>
                    ...
                    <div class="item-details-with-actions">
                        ...
                        <div class="item-actions">
                            <div class="quantity-selector">
                                ...
                                <button
                                class="quantity-change-button" 
                                @click="increaseOne(shoppingCartItems[4].id)">+</button>
                            </div>
                            <button class="remove-item">✕</button>
                        </div>
                    </div>
